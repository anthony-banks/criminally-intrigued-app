...
struct AboutView: View {
    ...
    private let privacyURL = AppConfig.privacyPolicyURL
    ...
    var body: some View {
        List {
            Section {
                ...
                Text("A respectful, factual reference reader for true-crime topics — serial killers, cold cases, and strange unsolved mysteries — sourced entirely from Wikipedia. It is a reference tool, not entertainment that sensationalizes crime.")
                    .font(.callout)
                    .foregroundStyle(Palette.labelPrimary)
            }
            ...
            Section("Developer") {
                Text("Contact: \(AppConfig.supportEmail)")
                    .font(.callout)
                    .foregroundStyle(Palette.labelSecondary)
            }
        }
